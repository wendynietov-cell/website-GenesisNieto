    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: [
            "0 0 0 0.5px rgba(195,162,122,0.18)",
            "0 8px 32px rgba(120,80,40,0.10)",
            "0 32px 80px rgba(120,80,40,0.07)",
            "inset 0 1px 0 rgba(255,255,255,0.90)",
            "inset 0 -1px 0 rgba(195,162,122,0.15)",
            "inset 1px 0 0 rgba(255,255,255,0.55)",
            "inset -1px 0 0 rgba(195,162,122,0.10)",
          ].join(", "),
        }}
      >
        {/* FOTO — desktop: derecha absoluta | mobile: oculta */}
        <div className="absolute inset-0 left-[48%] pointer-events-none hidden md:block">
          <img
        ...
        >
          ...
          >
            {name.split(" ").map((word, i) => (
              <span key={i} className="inline md:block">{i > 0 ? " " : ""}{word}</span>
            ))}
          </motion.h1>
          ...
          >
            <button
              ...
              className="flex-1 md:flex-none px-5 md:px-6 py-3 rounded-lg text-[10px] uppercase tracking-widest font-bold shadow-xl shadow-stone-900/10 transition-all hover:-translate-y-1 cursor-pointer"
              style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: "#2C1A0A", color: "#F5EDE0" }}
            >
              Ver portafolio
            </button>
            <button
              onClick={() => scrollTo("#contacto")}
              className="flex-1 md:flex-none px-5 md:px-6 py-3 rounded-lg text-[10px] uppercase tracking-widest font-bold transition-all hover:bg-white cursor-pointer"
              style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: "rgba(255,250,242,0.4)", color: "#7A5838", border: "1px solid rgba(176,136,90,0.3)" }}
            >
              Trabajemos juntos
            </button>
          </motion.div>
